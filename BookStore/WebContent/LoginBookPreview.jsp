		...
		<div id="bookList">
				<table id="tableBooks">
					<tr>
						...
						<td style="color: teal; border-bottom: 2px teal dotted"> Book title </td>
					...
					<tr>
						<td> ${counter}. </td>
						<td> ${book.title} (${book.status}) </td>
						<td id="update"> <a href="UpdateBookController?bID=${book.id}"> Update </a> </td>
						<td id="delete"> <a href="DeleteBookController?bID=${book.id}"> Delete </a> </td>
					</tr>
					</c:when>
					<c:otherwise>
					<tr>
						<td> ${counter}. </td>
						<td style="color: gray"> ${book.title} (${book.status}) </td>
						<td></td>
						<td id="revive" style="color: gray"> <a href="ReviveBookController?bID=${book.id}"> Revive </a> </td>
					</tr>
					</c:otherwise>
					</c:choose>
					</c:forEach>
